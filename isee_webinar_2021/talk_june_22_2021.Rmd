...
The `hurricaneexposure` R package: An open-source software to explore and map county-level hurricane exposure in the United States.
...
**county level**.
3. Share the data in a way that is easy to use in a way that 
...
Adapted from Yan et al., *Epidemiology*, 2021.
