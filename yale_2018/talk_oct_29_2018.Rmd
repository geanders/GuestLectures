...
matched_days <- data_frame(
  year = c(sample(c(1999:2004, 2006:2010), 10, replace = FALSE)),
  yday = c(sample(294:300, 10, replace = TRUE))
)
...
ggplot() + 
  ...
  ggtitle("All tropical cyclone wind exposures",
          subtitle = "Counties and storms with at least one exposure of 21 m/s or higher")
```
...
```{r fig.width = 7, fig.height = 4.5, out.width = "\\textwidth"}
wind_cumul_ests_21 <- readRDS("data/wind21_resp_est_July2018.rds")
wind_cumul_ests_18 <- readRDS("data/wind18_resp_est_July2018.rds")
wind_cumul_ests_15 <- readRDS("data/wind15_resp_est_July2018.rds")
wind_cumul_ests_12 <- readRDS("data/wind12_resp_est_July2018.rds")

wind_cumul_ests <- data_frame(threshold = c(12, 15, 18, 21),
                              rr = c(wind_cumul_ests_12$pred$allRRfit,
                                     wind_cumul_ests_15$pred$allRRfit,
                                     wind_cumul_ests_18$pred$allRRfit,
                                     wind_cumul_ests_21$pred$allRRfit),
                              low_ci = c(wind_cumul_ests_12$pred$allRRlow,
                                         wind_cumul_ests_15$pred$allRRlow,
                                         wind_cumul_ests_18$pred$allRRlow,
                                         wind_cumul_ests_21$pred$allRRlow),
                              
                              high_ci = c(wind_cumul_ests_12$pred$allRRhigh,
                                          wind_cumul_ests_15$pred$allRRhigh,
                                          wind_cumul_ests_18$pred$allRRhigh,
                                          wind_cumul_ests_21$pred$allRRhigh),
                              n = c(558, 338, 217, 123))
...
```{r fig.width = 7, fig.height = 4.5, out.width = "\\textwidth"}
wind_cumul_ests_21 <- readRDS("data/wind21_cvd_est_July2018.rds")
wind_cumul_ests_18 <- readRDS("data/wind18_cvd_est_July2018.rds")
wind_cumul_ests_15 <- readRDS("data/wind15_cvd_est_July2018.rds")
wind_cumul_ests_12 <- readRDS("data/wind12_cvd_est_July2018.rds")
...
```{r fig.width = 7, fig.height = 4.5, out.width = "\\textwidth"}
rain_cumul_ests_125 <- readRDS("data/rain125_resp_est_July2018.rds")
rain_cumul_ests_100 <- readRDS("data/rain100_resp_est_July2018.rds")
rain_cumul_ests_75 <- readRDS("data/rain75_resp_est_July2018.rds")
rain_cumul_ests_50 <- readRDS("data/rain50_resp_est_July2018.rds")

rain_cumul_ests <- data_frame(threshold = c(50, 75, 100, 125),
                              rr = c(rain_cumul_ests_50$pred$allRRfit,
                                     rain_cumul_ests_75$pred$allRRfit,
                                     rain_cumul_ests_100$pred$allRRfit,
                                     rain_cumul_ests_125$pred$allRRfit),
                              low_ci = c(rain_cumul_ests_50$pred$allRRlow,
                                         rain_cumul_ests_75$pred$allRRlow,
                                         rain_cumul_ests_100$pred$allRRlow,
                                         rain_cumul_ests_125$pred$allRRlow),
                              
                              high_ci = c(rain_cumul_ests_50$pred$allRRhigh,
                                          rain_cumul_ests_75$pred$allRRhigh,
                                          rain_cumul_ests_100$pred$allRRhigh,
                                          rain_cumul_ests_125$pred$allRRhigh),
                              n = c(919, 505, 267, 133))
...
```{r fig.width = 7, fig.height = 4.5, out.width = "\\textwidth"}
rain_cumul_ests_125 <- readRDS("data/rain125_cvd_est_July2018.rds")
rain_cumul_ests_100 <- readRDS("data/rain100_cvd_est_July2018.rds")
rain_cumul_ests_75 <- readRDS("data/rain75_cvd_est_July2018.rds")
rain_cumul_ests_50 <- readRDS("data/rain50_cvd_est_July2018.rds")
...
You can also use this package to map all counties with events near the time and location of a tropical cyclone:
...
\medskip
Download weather monitor data through the NOAA API by U.S. county. Includes functions to map available monitors for each county. On CRAN.
\end{block}
...
```
```{r echo = TRUE}
head(andrew_precip$daily_data, 3)
```
...
This package allows you to plot daily weather data:

```{r fig.align = "center", echo = TRUE, fig.width = 7, fig.height = 3, out.width="\\textwidth"}
...
- `stormwindmodel`: Model hurricane winds from Best Track data.
- `countyfloods`: Query and explore USGS flood gage data based on county identifiers.
- `countytimezones`: Link data with UTM and local time zones.
