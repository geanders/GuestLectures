...
For the main text, all format is down using **Markdown** syntax. 
...
Often lots of preprocessing required for data from **complex equipment** that
...
- This is typically based on a **GUI** [more on this]
- You can use this for your preprocessing, but there are some 
very good reasons to use code instead, when possible.
